...
const OfferBanner = () => {
  ...
  // Get the professional price from environment variable and add 1
  const professionalPrice = import.meta.env.VITE_PROFESSIONAL_PRICE
    ? parseInt(import.meta.env.VITE_PROFESSIONAL_PRICE) + 1
    : 750;
