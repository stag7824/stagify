    ...
    <header className={`sticky ${showBanner ? 'top-16' : 'top-0'} z-40 bg-white dark:bg-gray-900 shadow-md transition-colors duration-300`}>
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <div className="flex items-center space-x-1">
          <img src="/stagify-logo.svg" alt="Bugbrew Logo" className="h-8 w-8" />
          <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary animate-gradient-shift bg-[length:200%_auto]">Bugbrew</h1>
        </div>
